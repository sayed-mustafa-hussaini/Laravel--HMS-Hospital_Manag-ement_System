            ...
            <table class="table table-striped table-bordered table-sm text-nowrap w-100 dataTable no-footer table-main"
                ...
                <thead>
                    <tr>
                        ...
                        <th>Extra Hours</th>
                        <th>Total</th>
                        @if (!empty(Helper::getpermission('_overTimePaymentBill--edit')) || !empty(Helper::getpermission('_overTimePaymentBill--delete')))
                            <th>Action</th>
                        @endif
                    </tr>
                </thead>
                ...
                <div class="modal-body pd-20">
                    ...
                    <form method="post" id="createform">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="hours" placeholder="Hourse">
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body pd-20">
                    ...
                    <form method="post" id="editform">
                        ...
                        <div class="form-group">
                            <label>Extra Hours</label>
                            <input type="number" class="form-control" name="hours" placeholder="Hourse" id="hourse1">
                        </div>
                        <div class="form-group">
                            <label>Total Amount</label>
                            <input type="number" class="form-control" name="total_amount" placeholder="Amount" id="amount1">
                        </div>
